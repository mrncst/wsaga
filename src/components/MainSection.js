        ...
        <React.Fragment>
            ...
            <img className='logo' src={require('../images/logo-svg.svg')} />
                <div className='text-intro'>
                    ...
                    <p className='intro'>Uma curadoria feita com carinho sobre os dois assuntos que mais têm bombado no mercado: product management e data science, produzidos exclusivamente por mulheres. 
